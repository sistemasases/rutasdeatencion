...
$(function () {
  ...
  Promise.all([screenResponsiveWebDesing(json), svgPaint(json), rutesAttentionMovil(json)], getJsonNew(json))
...
function getJsonNew(json) {
  ...
  json.then((value) => {
    ...
    console.log( Object.entries(((Object.entries((Object.entries((Object.values(value)[0]).TiposDeAtencion)[1])[1].sedes)[0])[1]).Entidades) )
