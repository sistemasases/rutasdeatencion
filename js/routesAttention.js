...
function funcionalityRute(json, dimension, attetionAux, entity, iterador, indexCap) {
  ...
  json.then(function (value) {
    ...
    try {
      ...
      if (dimension == 0) {
        objectJson = [(((Object.entries((Object.values(value)[dimension]).TiposDeAtencion)))),Object.entries(Object.values(((Object.entries((Object.values(value)[dimension]).TiposDeAtencion))[attetionAux])[1])[2]) ]
      }
      else {
        objectJson = [Object.keys((Object.entries(value)[dimension])[2])]
      }
